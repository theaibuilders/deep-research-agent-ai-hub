...
- "What's the weather in San Francisco today?" → Gets current weather data
- "What is the current price of Bitcoin?" → Gets latest price
- "Best Thai restaurants in San Francisco" → Gets current reviews

**With Web Search Disabled (checkbox unchecked):**
- Same questions → Gets general information without real-time data
- "What is the capital of France?" → Answers directly from LLM knowledge
- "Explain quantum computing" → Answers from training data
